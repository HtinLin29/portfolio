...
var InView = class extends import_react.Component {
	...
	observeNode() {
		...
		const { threshold, root, rootMargin, scrollMargin, trackVisibility, delay, fallbackInView } = this.props;
	...
	render() {
		...
		const { as, triggerOnce, threshold, root, rootMargin, scrollMargin, onChange, skip, trackVisibility, delay, initialInView, fallbackInView, ...props } = this.props;
...
var useOnInView = (onIntersectionChange, { threshold, root, rootMargin, scrollMargin, trackVisibility, delay, triggerOnce, skip } = {}) => {
